...
export class Br implements Codec, SelectionBar {
	...
	constructor(o: IBr, index: number, track: Track, config: MuseConfig) {
		this.index = index;
		this.track = track;
		this.config = config;
		this.decode(o);
...
class ZBar extends React.Component<IMuseBarProps, {}> {
	render() {
